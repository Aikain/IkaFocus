...
const Island = ({ account, deleteIsland, island, updateIsland }: Props) => {
    ...
    const handleBuildLevelChange = (index: number, building: BuildingKey, newValue?: number) =>
        updateIsland({
            ...island,
            cities: [
                ...island.cities.slice(0, index),
    ...
    return (
        <div className={styles.island}>
            <div className={styles.islandDetails}>
                ...
                <div>
                    <label htmlFor='luxuryLevel'>{translateLuxuryResource(island.luxuryResource)} taso:</label>
                    <input
                        id='luxuryLevel'
                        type='number'
